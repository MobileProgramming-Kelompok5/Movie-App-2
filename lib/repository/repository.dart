...
import 'package:movie_app_3/model/genre_response.dart';
...
class MovieRepository {
  final String apiKey = "5a67cb14667c5eb97edec7496820de08";
  ...
  Future<MovieResponse> getSearch(String query) async {
    var params = {
      "api_key": apiKey,
      "language": "en-US",
      "query": query,
